...
import { OMNIDEF } from './applicantEducationalInformationEnglish_def.js';
import tmpl from './applicantEducationalInformationEnglish.html';
import tmpl_nds from './applicantEducationalInformationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicantEducationalInformationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
