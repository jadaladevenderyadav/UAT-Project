...
import { OMNIDEF } from './hariPOCEnglish_def.js';
import tmpl from './hariPOCEnglish.html';
import tmpl_nds from './hariPOCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class hariPOCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
