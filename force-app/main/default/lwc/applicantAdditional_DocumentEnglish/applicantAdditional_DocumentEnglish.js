...
import { OMNIDEF } from './applicantAdditional_DocumentEnglish_def.js';
import tmpl from './applicantAdditional_DocumentEnglish.html';
import tmpl_nds from './applicantAdditional_DocumentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicantAdditional_DocumentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
