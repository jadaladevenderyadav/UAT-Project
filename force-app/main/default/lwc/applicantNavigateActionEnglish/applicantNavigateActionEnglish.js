...
import { OMNIDEF } from './applicantNavigateActionEnglish_def.js';
import tmpl from './applicantNavigateActionEnglish.html';
import tmpl_nds from './applicantNavigateActionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicantNavigateActionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
