...
import { OMNIDEF } from './applicantPOLetterDeclarationEnglish_def.js';
import tmpl from './applicantPOLetterDeclarationEnglish.html';
import tmpl_nds from './applicantPOLetterDeclarationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicantPOLetterDeclarationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
