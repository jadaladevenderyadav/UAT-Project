...
import { OMNIDEF } from './applicantParentDetailsEnglish_def.js';
import tmpl from './applicantParentDetailsEnglish.html';
import tmpl_nds from './applicantParentDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicantParentDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
