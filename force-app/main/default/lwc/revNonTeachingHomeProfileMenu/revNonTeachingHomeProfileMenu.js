...
const CONTACT_FIELDS = ['Contact.File_Passport_Size_Photo__c', 'Contact.hed__Gender__c', 'Contact.Name', 'Contact.MailingStreet',  'Contact.MailingState', 'Contact.MailingCountry', 'Contact.MailingPostalCode', 'Contact.SRN_Number__c', 'Contact.MobilePhone', 'Contact.School_Name__c',  'Contact.Program_Batch_Name__c', 'Contact.Date_of_Admission_in_Institute__c', 'Contact.Enrollment_Type__c', 'Contact.Student_Status__c', 'Contact.Email',];
...
export default class RevNonTeachingHomeProfileMenu extends NavigationMixin(LightningElement) {

	currentDate;
	showMainMenuSection = true;
	showProfileSection = false;
	circumference = 2 * Math.PI * 15; // 2 * π * radiuso
