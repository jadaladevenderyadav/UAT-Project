...
import { OMNIDEF } from './applicantAddress_UpdationEnglish_def.js';
import tmpl from './applicantAddress_UpdationEnglish.html';
import tmpl_nds from './applicantAddress_UpdationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicantAddress_UpdationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
