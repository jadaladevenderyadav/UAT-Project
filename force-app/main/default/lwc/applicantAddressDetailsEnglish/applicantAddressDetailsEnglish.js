...
import { OMNIDEF } from './applicantAddressDetailsEnglish_def.js';
import tmpl from './applicantAddressDetailsEnglish.html';
import tmpl_nds from './applicantAddressDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicantAddressDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
