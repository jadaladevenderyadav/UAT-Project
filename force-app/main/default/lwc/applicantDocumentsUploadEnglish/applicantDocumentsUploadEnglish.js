...
import { OMNIDEF } from './applicantDocumentsUploadEnglish_def.js';
import tmpl from './applicantDocumentsUploadEnglish.html';
import tmpl_nds from './applicantDocumentsUploadEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicantDocumentsUploadEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
