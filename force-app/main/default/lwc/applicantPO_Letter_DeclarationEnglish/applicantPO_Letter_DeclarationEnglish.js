...
import { OMNIDEF } from './applicantPO_Letter_DeclarationEnglish_def.js';
import tmpl from './applicantPO_Letter_DeclarationEnglish.html';
import tmpl_nds from './applicantPO_Letter_DeclarationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicantPO_Letter_DeclarationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
