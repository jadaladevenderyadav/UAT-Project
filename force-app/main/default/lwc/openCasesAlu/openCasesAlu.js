...
export default class OpenCasesAlu extends NavigationMixin(LightningElement) {
    @track caseList;
    @track error;
    @track isOpenCases = true;
    @track noCaseData = false;

  @wire(getCaseList, { caseStatus: "New"})
  wiredCases({ error, data }) {
    if (data) {
      this.caseList = data;
      console.log('casedata--->'+this.caseList);
      if(this.caseList==''){
