...
import { OMNIDEF } from './applicantAddress_DetailsEnglish_def.js';
import tmpl from './applicantAddress_DetailsEnglish.html';
import tmpl_nds from './applicantAddress_DetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicantAddress_DetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
