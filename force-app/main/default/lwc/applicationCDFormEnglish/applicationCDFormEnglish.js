...
import { OMNIDEF } from './applicationCDFormEnglish_def.js';
import tmpl from './applicationCDFormEnglish.html';
import tmpl_nds from './applicationCDFormEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicationCDFormEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
