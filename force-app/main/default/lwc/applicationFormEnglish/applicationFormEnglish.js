...
import { OMNIDEF } from './applicationFormEnglish_def.js';
import tmpl from './applicationFormEnglish.html';
import tmpl_nds from './applicationFormEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicationFormEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
