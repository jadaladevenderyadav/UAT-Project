...
import { OMNIDEF } from './applicantCET_RegistrationEnglish_def.js';
import tmpl from './applicantCET_RegistrationEnglish.html';
import tmpl_nds from './applicantCET_RegistrationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicantCET_RegistrationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
