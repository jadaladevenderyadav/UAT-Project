...
import { OMNIDEF } from './applicantParent_DetailsEnglish_def.js';
import tmpl from './applicantParent_DetailsEnglish.html';
import tmpl_nds from './applicantParent_DetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicantParent_DetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
