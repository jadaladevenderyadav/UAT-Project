...
import { OMNIDEF } from './applicantPassportDetailsEnglish_def.js';
import tmpl from './applicantPassportDetailsEnglish.html';
import tmpl_nds from './applicantPassportDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicantPassportDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
