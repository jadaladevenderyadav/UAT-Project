...
import { OMNIDEF } from './applicantEducational_InformationEnglish_def.js';
import tmpl from './applicantEducational_InformationEnglish.html';
import tmpl_nds from './applicantEducational_InformationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicantEducational_InformationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
