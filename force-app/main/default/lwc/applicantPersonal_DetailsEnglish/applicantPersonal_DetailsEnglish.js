...
import { OMNIDEF } from './applicantPersonal_DetailsEnglish_def.js';
import tmpl from './applicantPersonal_DetailsEnglish.html';
import tmpl_nds from './applicantPersonal_DetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicantPersonal_DetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
