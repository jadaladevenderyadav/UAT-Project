...
import { OMNIDEF } from './applicantPersonalDetailsEnglish_def.js';
import tmpl from './applicantPersonalDetailsEnglish.html';
import tmpl_nds from './applicantPersonalDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicantPersonalDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
