...
import { OMNIDEF } from './applicantPassport_DetailsEnglish_def.js';
import tmpl from './applicantPassport_DetailsEnglish.html';
import tmpl_nds from './applicantPassport_DetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicantPassport_DetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
