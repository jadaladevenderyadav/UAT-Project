...
import { OMNIDEF } from './applicantDocumentChecklist_CETEnglish_def.js';
import tmpl from './applicantDocumentChecklist_CETEnglish.html';
import tmpl_nds from './applicantDocumentChecklist_CETEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicantDocumentChecklist_CETEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
