...
import { OMNIDEF } from './applicantDocuments_UploadEnglish_def.js';
import tmpl from './applicantDocuments_UploadEnglish.html';
import tmpl_nds from './applicantDocuments_UploadEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicantDocuments_UploadEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
