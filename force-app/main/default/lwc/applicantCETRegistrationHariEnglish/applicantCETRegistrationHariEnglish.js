...
import { OMNIDEF } from './applicantCETRegistrationHariEnglish_def.js';
import tmpl from './applicantCETRegistrationHariEnglish.html';
import tmpl_nds from './applicantCETRegistrationHariEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicantCETRegistrationHariEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
