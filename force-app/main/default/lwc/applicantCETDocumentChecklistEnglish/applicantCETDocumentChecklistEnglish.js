...
import { OMNIDEF } from './applicantCETDocumentChecklistEnglish_def.js';
import tmpl from './applicantCETDocumentChecklistEnglish.html';
import tmpl_nds from './applicantCETDocumentChecklistEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicantCETDocumentChecklistEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
